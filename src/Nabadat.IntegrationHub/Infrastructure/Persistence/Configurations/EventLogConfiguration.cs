...
/// <c>HasColumnName</c> per property (DB-08); <c>old_value</c> / <c>new_value</c> are <c>jsonb</c>. The
/// table is append-only — M-13 only ever inserts rows here. Mirrors the M-06 / M-10 / M-16 mapping.
/// </summary>
