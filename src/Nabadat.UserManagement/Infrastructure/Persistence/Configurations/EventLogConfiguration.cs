...
/// <summary>
/// Maps <see cref="EventLog"/> to M-10's tenant-schema <c>event_log</c> table. Explicit
/// <c>HasColumnName</c> per property (DB-08); <c>old_value</c> / <c>new_value</c> are
/// <c>jsonb</c> (database-constitution Article 4.6). The table is append-only — M-10
/// only ever inserts rows here.
/// </summary>
