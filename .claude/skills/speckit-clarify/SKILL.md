...
> **Testing-flow note (see CLAUDE.md).** Treat an empty or vague coverage block in spec.md (no concrete cases / endpoints / flows) as an underspecified area worth a clarifying question.
