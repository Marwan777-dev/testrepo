...
> **Testing-flow note (see CLAUDE.md).** For a testing-focused checklist, derive items from the story's coverage blocks in spec.md — one check per Required case / endpoint / E2E scenario.
